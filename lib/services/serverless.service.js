...
var ServerlessService = (function () {
    ...
    ServerlessService.prototype.processGlueJobs = function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var jobs, params, _i, jobs_2, job, jobCFId, jobCFTemplate, bucketTemplate;
                ...
                switch (_j.label) {
                    ...
                    case 3:
                        for (_i = 0, jobs_2 = jobs; _i < jobs_2.length; _i++) {
                            job = jobs_2[_i];
                            jobCFId = (_g = job.id) !== null && _g !== void 0 ? _g : string_utils_1.StringUtils.toPascalCase(job.name);
                        ...
                        if (jobs.filter(function (e) { return e.tempDir; }).length > 0 &&
                            !((_h = this.config) === null || _h === void 0 ? void 0 : _h.tempDirBucket)) {
